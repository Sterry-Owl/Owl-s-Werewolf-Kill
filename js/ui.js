...
const UI = {
    ...
    getTopTagStyle: function(text) {
        const colorMap = {
            ...
            '守墓人': '#FF9851', '攝夢人': '#FF9851', '烏鴉': '#FF9851', '白痴': '#FF9851', '守衛': '#FF9851', '魔術師': '#FF9851', '奇蹟商人': '#FF9851', '流光伯爵': '#FF9851', '白晝學者': '#FF9851', '白貓': '#FF9851', '覺醒愚者': '#FF9851',
            '石像鬼': '#4d170d', '尋香魅影': '#4d170d', '機械狼': '#4d170d', '隱狼': '#4d170d',
            '狼巫': '#3d031a', '惡靈騎士': '#3d031a', '巫妖': '#3d031a',
            '白狼王': '#7f203b', '血月使徒': '#7f203b', '狼王': '#7f203b', '狼美人': '#7f203b', '狼鴉之爪': '#7f203b', '覺醒狼美人': '#7f203b',
