...
const GAME_PHASE = {
    ...
    AWAKENED_HUNTER_ACTION: 'AWAKENED_HUNTER_ACTION',
...
const TEMPLATES_TEST = [
    ...
    { id: "test_math", name: "雙機械狼測試", category: 'test', playerCount: 6, deck: ["魔鏡少女", "女巫", "騎士", "守衛", "機械狼", "機械狼"] },
];
...
const TEMPLATES_FUN = [
    ...
    { id: "whip_7", name: "7人 連連看", category: 'fun', playerCount: 7, deck: ["獵魔人", "獵魔人", "尋香魅影", "尋香魅影", "尋香魅影", "尋香魅影", "狼人"] },
...
const TEMPLATES_QUICK = [
    ...
    { id: "inw_cl_10", name: "10人 咒狐隱狼烏鴉", category: 'quick', playerCount: 10, deck: ["預言家", "女巫", "烏鴉", "隱狼", "狼人", "狼人", "平民", "平民", "平民", "咒狐"] },
    ...
    { id: "nightmare_11", name: "11人 夢魘守衛", category: 'quick', playerCount: 11, deck: ["預言家", "女巫", "獵人", "守衛", "噩夢之影", "狼王", "狼人", "平民", "平民", "平民", "平民"] },
    { id: "wildchild_11", name: "11人 狼美人野孩子", category: 'quick', playerCount: 11, deck: ["預言家", "女巫", "騎士", "守衛", "狼美人", "狼人", "狼人", "平民", "平民", "平民", "野孩子"] },
    { id: "dreamer_11", name: "11人 狼王攝夢人", category: 'quick', playerCount: 11, deck: ["預言家", "女巫", "獵人", "攝夢人", "狼王", "狼人", "寂夜導師", "平民", "平民", "平民", "平民"] },
];
...
const TEMPLATES_STANDARD = [
    ...
    { id: "inw_cl_12", name: "12人 咒狐隱狼烏鴉", category: 'standard', playerCount: 12, deck: ["預言家", "女巫", "獵人", "烏鴉", "隱狼", "狼人", "狼人", "狼人", "平民", "平民", "平民", "咒狐"] },
    ...
    { id: "archer_12", name: "12人 天狗月女", category: 'standard', playerCount: 12, deck: ["預言家", "女巫", "獵人", "月女", "天狗", "狼人", "狼人", "狼人", "平民", "平民", "平民", "平民"] },
    { id: "math_12", name: "12人 數學家魔術師", category: 'standard', playerCount: 12, deck: ["數學家", "女巫", "獵人", "魔術師", "狼王", "石像鬼", "狼人", "狼人", "平民", "平民", "平民", "平民"] },
];
...
function buildRecommendedRules(tpl) {
    ...
    if (tpl.name.includes('無目之夜') || tpl.name.includes('無目之城') || tpl.name.includes('咒狐隱狼烏鴉')) {
        rec.hiddenWolfType = 'strong';
    }
    if (tpl.name.includes('巫妖隱狼') || tpl.name.includes('大野狼旅客') || tpl.name.includes('隱狼野孩子')) {
        rec.hiddenWolfType = 'weak';
    }
...
const ROLE_DICTIONARY = {
    ...
    "定序王子": { faction: "good", type: "god", nightPhase: "second_half", actionType: "single_select", prompt: "", description:"神職；每局限用一次。白天投票後，可翻牌逆轉時光使該次投票作廢，並獲得一次額外發言機會後重新投票。發動技能後的下一個夜晚，若原投票目標為好人，則夜晚定序王子可以擊殺一名玩家。" },
    ...
    "大野狼": { faction: "wolf", type: "wolf", nightPhase: ["midnight", "second_half"], actionType: "dynamic", prompt: "大野狼請行動\n(點擊左右列頭貼以發動技能)", description: "狼人陣營；參與狼隊襲擊。每個後半夜可單獨睜眼額外擊殺一名玩家。當任意狼人出局後，大野狼失去此技能。若大野狼選擇的目標與當夜狼隊襲擊的目標相同，將可以無視任何防禦。"},
    ...
    // ==========================================
    // 4. 第三方與特殊陣營 (Third Party & Special)
    // ==========================================
