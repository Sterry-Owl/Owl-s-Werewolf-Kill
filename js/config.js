...
const TEMPLATES_TEST = [
    ...
    { id: "test-30_6", name: "巫妖轉化(測試)", category: 'test', playerCount: 6, deck: ["預言家", "熊", "純白之女", "巫妖", "狼人", "平民"] },
];
...
const TEMPLATES_STANDARD = [
    ...
    { id: "awakendlich_12", name: "12人 覺醒石像鬼", category: 'standard', playerCount: 12, deck: ["預言家", "女巫", "獵人", "守衛", "攝夢人", "覺醒石像鬼", "狼王", "狼人", "平民", "平民", "平民", "平民"] },
];
